...
function setRawsRule(raws, opts) {
  setAtRuleSemicolonNewlineAfter(raws, opts)
  raws.before = opts.atruleBefore
  raws.between = ' '
  raws.afterName = ' '
}

function setAtRuleSemicolonNewlineAfter(raws, opts) {
