...
function formatSelectors (rule, stylelint) {
  var tmp = []
  ...
  var separator = selectorListCommaSpaceBefore(stylelint, isSingleLine)
...
function selectorListCommaSpaceBefore(stylelint, isSingleLine) {
